...
def plot(t_j,e_j,a_j,i_j,t_s,e_s,a_s,i_s,t_u,e_u,a_u,i_u,t_n,e_n,a_n,i_n,k):
    ...
    plt.ylabel('e')
    plt.plot(t_n,e_n,'r-')
    plt.savefig('/Users/jamesleepc/astroprogram/pics/e-t Stage{0}.png'.format(k))
    plt.figure(2)
    ...
    plt.ylabel('a')
    plt.plot(t_n,a_n,'r-')
    plt.savefig('/Users/jamesleepc/astroprogram/pics/a-t Stage{0}.png'.format(k))
    ...
    plt.ylabel('i')
    plt.plot(t_n,i_n,'r-')
    plt.savefig('/Users/jamesleepc/astroprogram/pics/i-t Stage{0}.png'.format(k))
    plt.close('all')
